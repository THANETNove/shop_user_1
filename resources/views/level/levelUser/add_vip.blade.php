            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form  method="post"  action="{{route('level_user.store' )}}"  enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('ID UserName') }}</label>
                                 <div class="col-md-6">
                                    <input id="store" type="text" 
                                    class="form-control @error('store') is-invalid @enderror" name="userid"
                                    value="{{$user[0]->id}}" required  autofocus>     
                                </div>
                            </div> 
                            <div class="row mb-3">
